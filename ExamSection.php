    ...
    <form method="post">
        ...
        <header class="header-container">
            <nav class="navbar navbar-dark bg-dark" style="position: relative;">
                ...
                <h6 style="color: rgba(255, 255, 255, 0.7); margin-left: 20px; position:absolute; right: 10px; font-size: 12px;">Powered By DNM @ Copyright 2022</h6>
            </nav>
            <hr>
            ...
            <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups" style="display: grid; grid-template-rows: auto auto">
    ...
    <div class="table-container">
        <form method="post">
            ...
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="Enter Student's ID" aria-label="Recipient's username" aria-describedby="basic-addon2" name="id">
            ...
            <div class="m1">
                    ...
                    <tbody>
                        ...
                        ?>
                                        <tr>
                                            ...
                                            <td style="border: 1px solid gray;">
                                                <input type="number" value="<?php echo $col['ese'] ?>" name="<?php echo str_replace(" ",  "",$col['subject'])?>"/>
                                            </td>
                                            <td style="border: 1px solid gray;">
                                                <input type="number" value="<?php echo $col['ia_tw'] ?>" name="<?php echo str_replace(" ",  "", $col['subject'])?>"/>
                                            </td>
                                            <td style="border: 1px solid gray;">
                                                <input type="number" value="<?php echo $col['overall'] ?>" name="<?php echo str_replace(" ",  "", $col['subject'])?>"/>
                                            </td>
                                            <td style="border: 1px solid gray;">
                                                <input type="number" value="<?php echo $col['credits_earned'] ?>" name="<?php echo str_replace(" ",  "", $col['subject'])?>"/>
                                            </td>
                                            <td style="border: 1px solid gray;">
                                                <input type="number" value="<?php echo $col['credits_pts'] ?>" name="<?php echo str_replace(" ",  "", $col['subject'])?>"/>
                                            </td>
                                            <td style="border: 1px solid gray;">
                                                <input type="number" value="<?php echo $col['cxg'] ?>" name="<?php echo str_replace(" ",  "", $col['subject'])?>"/>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
                ...
                <button type="submit" class="btn btn-primary" style="position: absolute; left: 50%; transform" name="button1" id="button1">Primary</button>
                <?php 
                 echo "";             
