        ...
        <form method="post" action="
            ...
            <div class="input-group mb-3">
                ...
                <span class="input-group-text" id="basic-addon2"
                    style="background-color: rgb(90, 250, 100); color:slategray">
                    <button type="submit" name="search"
                        style="border:none; background-color:inherit;color:inhert">Search</button>
                    <span id="search-icon">
            ...
            <div class="m1">
                ...
                <table class="table table-dark" style="text-align: center;">
                    ...
                    <tbody>
                        ...
                        if ($con) {
                            ...
                            echo "
                                    <script>    
                                        ...
                                        document.getElementById('scheme').textContent = String('Scheme : " . $scheme['scheme'] . "')
                                    </script>
                                ";
                        ...
                        <?php } ?>
                        <?php
                            $sem = "sem" . $_SESSION['sem_no'];
                            $filename = mysqli_fetch_assoc($con->query('SELECT ' . $sem . ' FROM files WHERE sid = "' . $_SESSION['id'] . '";'));
                        } ?>
                        <?php //} 
                        ?>
                    </tbody>
                ...
                <?php if (isset($filename)) {
                    echo '<iframe src="./pdf/' . $filename[$sem] . '" width="800" height="600">';
                } ?>
