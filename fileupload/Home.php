    ...
    if (isset($_POST['submit'])) {
        ...
        if ($con) {
            ...
            if ($con->query($new_student)) {
                $emptyfiles = "INSERT INTO `files` (`sid`, `sem1`, `sem2`, `sem3`, `sem4`, `sem5`, `sem6`, `sem7`, `sem8`, `receipt`) VALUES ('" . $_POST['mobile-number'] . "', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)";
                if ($con->query($emptyfiles)) header('location: DataEntry.php');
            } else $con->error;
        } else {
            echo $con->error;
        }
